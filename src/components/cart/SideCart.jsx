      ...
      <div style={{ padding: "22px 60px" }}>
        ...
        {cartData ? (
          ...
          >
            ...
            <button className="cormorant-font cart-cs-btn" style={{ width: 'max-content'}}>CONTINUE SHOPPING</button>
            <div
        style={{
        //   padding: "40px 60px",
          display: "flex",
          ...
          >
            <div style={{ display: "flex", gap: "30px" }}>
              ...
              >
                ...
                <span style={{ color: "#919385", fontSize: "12px" }}>
                  PRICE/h:{" "}
                  <span style={{ color: "#fff", fontSize: "12px" }}>$50</span>
                </span>
                <span style={{ color: "#919385", fontSize: "12px" }}>
                  TIME:{" "}
                ...
                <span style={{ color: "#919385", fontSize: "12px" }}>
                  TOTAL:{" "}
                  <span style={{ color: "#fff", fontSize: "12px" }}>$150</span>
                </span>
                <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: "#fff", fontSize: "16px" }}>$150.00</span>
          </div>
          <button className="signup-btn">Checkout</button>
        </div>
      </div>
    </div>
  );
